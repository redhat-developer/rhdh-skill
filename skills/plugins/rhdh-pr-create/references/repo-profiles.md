...
Auto-detect which repository you are in and load the matching profile. Read this file at the start of every pull-request publication.
...
The template has conditional sections. Include or omit them based on the resolved issue context and the change handoff from Step 1.5.

```
## Description
<generated description — 2-4 sentences explaining what changed and why>

<pr_description_extra — if derived from the handoff's root cause, insert here>
...
## Note                                ← include for a bug-fix change handoff
> This bug fix was implemented with /rhdh-plugin-bug-fix and published with /rhdh-pr-create. Please verify it thoroughly before merging.
```
