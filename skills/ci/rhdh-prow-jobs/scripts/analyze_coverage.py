...
from rhdh_prow.openshift_release import (
    extract_branch,
    fetch_yaml,
    list_yaml_files,
    resolve_repo_root,
)
from rhdh_prow.versions import ver_sort_key
...
def _get_rhdh_lifecycle():
    """Get RHDH lifecycle data from the authoritative product API."""
...
def _get_ocp_lifecycle(today):
    """Get OCP lifecycle data from the authoritative product API."""
    import re
